#!/usr/bin/env python3
"""
v12 Training Script: Improved Term-Level KO-EN Neural Sparse Model

Key improvements from v11:
1. Better data composition (77% MUSE, filtered Wikidata)
2. Increased target loss weight for stronger English activation
3. Higher margin threshold
"""
...
CONFIG = {
    ...
    'max_length': 64,
    'data_path': PROJECT_ROOT / 'dataset' / 'v12_improved' / 'term_pairs.jsonl',
    'batch_size': 128,
    ...
    'max_grad_norm': 1.0,
    'lambda_self': 1.0,
    'lambda_target': 5.0,  # Increased from 2.0 to force stronger EN activation
    'lambda_margin': 3.0,  # Increased from 1.5
    'lambda_negative': 0.5,
    'lambda_sparsity': 0.01,
    'target_margin': 2.0,  # Increased from 1.0 - minimum activation threshold
    'output_dir': PROJECT_ROOT / 'outputs' / 'v12_improved',
}
...
def main():
    print("=" * 70)
    print("v12 TRAINING: Improved Term-Level KO-EN Neural Sparse Model")
    print("=" * 70)
    ...
    print(f"\nHyperparameters:")
    print(f"  lambda_target: {CONFIG['lambda_target']}")
    print(f"  lambda_margin: {CONFIG['lambda_margin']}")
    print(f"  target_margin: {CONFIG['target_margin']}")

#!/usr/bin/env python3
"""
v13 Training Script: Noun-Focused KO-EN Neural Sparse Model

Key improvements from v12:
1. Noun-only training data (filtered for nouns in both KO and EN)
2. Focus on terminology that matters for information retrieval
"""
...
CONFIG = {
    ...
    'max_length': 64,
    'data_path': PROJECT_ROOT / 'dataset' / 'v13_nouns' / 'term_pairs.jsonl',
    'batch_size': 128,
    'num_epochs': 10,
    'learning_rate': 2e-5,
    'warmup_ratio': 0.1,
    ...
    'target_margin': 2.0,
    'output_dir': PROJECT_ROOT / 'outputs' / 'v13_nouns',
}
...
def main():
    print("=" * 70)
    print("v13 TRAINING: Noun-Focused KO-EN Neural Sparse Model")
    print("=" * 70)

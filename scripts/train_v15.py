#!/usr/bin/env python3
"""
v15 Training Script: Aggressive Oversampling for Problematic Terms

Key improvements from v14:
1. CRITICAL terms (추천→recommend, 신경망→neural, 강화학습→reinforcement): 100x oversampling
2. Core IT terms: 50x oversampling (up from 10x)
3. More term variants added for problematic mappings
"""
...
CONFIG = {
    ...
    'target_margin': 2.0,
    'output_dir': PROJECT_ROOT / 'outputs' / 'v15_aggressive',
}
...
def main():
    print("=" * 70)
    print("v15 TRAINING: Aggressive Oversampling KO-EN Neural Sparse Model")
    print("=" * 70)

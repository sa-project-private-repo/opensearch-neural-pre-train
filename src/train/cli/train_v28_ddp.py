"""
V28 Multi-GPU Training with DistributedDataParallel (DDP).

Supports 8x A100 GPUs for efficient large-scale training.
...
Usage:
    ...
    # With custom config
    torchrun --nproc_per_node=8 -m src.train.cli.train_v28_ddp --epochs 30 --batch-size 32
